...
// function arrayRecievedOutput(receivedOutput){
//     this.receivedOutput = receivedOutput
//     const j = recievedOutput.length
...
//         console.log(recievedOutputArrayELement)
//         recievedOutputArray[i] = recievedOutputArrayELement
//       }
//       return recievedOutputArray
// }
...
describe('Mounted App', () => {
    ...
    test("Given we selected a course, select a second course", async ()=>
    {
        ...
        console.log(wrapper.vm.modules.length)
